    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This will permanently delete this agenda template. This action cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        {isDefault && (
          <div className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-200">
            This is the default template for this board. Consider setting another template as
